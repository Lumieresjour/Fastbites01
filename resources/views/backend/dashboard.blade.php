    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-statistic-2">
                ...
                <div class="card-icon shadow-primary" style="background-color: #FF5962;">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-header-action">
                    <a data-collapse="#mycard-collapse" class="btn btn-icon" style="background-color: #FF5962; color: white; border-color: #FF5962;" href="#"><i class="fas fa-minus"></i></a>
                </div>
              </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('feature.order.show',$order->id) }}"
                                        class="btn" style="background-color: #FF5962; color: white; border-color: #FF5962;">Detail</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                            ...
                            <div class="product-item pb-3">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="product-cta">
                                        <a href="#" class="btn" style="background-color: #FF5962; color: white; border-color: #FF5962;">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
