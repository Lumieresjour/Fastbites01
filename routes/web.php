...
use App\Http\Controllers\Frontend\NotifController as FrontendNotifController;
...
// Ruote Reward
Route::get('/reward', [FrontendRewardController::class,'index'])->name('reward.index');

// Ruote Notifikasi
Route::get('/notif', [FrontendNotifController::class,'index'])->name('notif.index');
